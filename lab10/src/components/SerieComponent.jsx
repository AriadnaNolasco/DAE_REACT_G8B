...
function SerieComponent(props) {
  ...
  const mostrarImagen = props.imagen?.startsWith("blob:")
    ? props.imagen
    : `https://dummyimage.com/400x250/000/fff&text=${props.imagen}`;
    ...
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="d-flex justify-content-between">
          ...
          <button onClick={() => props.onDelete(props.codigo)} className="btn btn-danger">Eliminar</button>
        </div>
      </div>
    </div>
  );
